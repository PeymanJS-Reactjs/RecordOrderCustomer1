const BillingAddress = () => {
  return (
    <section className="rounded-lg mb-6 border border-gray-100">
      ...
      <div className="p-5 grid grid-cols-6 gap-x-4 gap-y-3">
        ...
        <div className="col-span-2">
          ...
          <select
            ...
            className="w-full border mt-1 text-gray-600 focus:text-gray-900 rounded-md border-gray-100 p-3 outline-none focus:border-primary transition-all"
          >
            <option value="washington-dc" selected>Washington DC</option>
        ...
        <div className="col-span-6">
          <button className="px-7 mt-2 py-2.5 text-sm rounded-full bg-primary hover:bg-primary/80 text-white">
            Save Changes
          </button>
        </div>
      </div>
