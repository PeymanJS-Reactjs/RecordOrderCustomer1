...
const OrderHistory = () => {
  ...
  return (
    <div className='md:border border-gray-100 col-span-7 rounded-lg '>
      <h3 className='p-4 pb-6 border-b  border-gray-100 text-lg w-full font-medium'>Order History</h3>
