...
const Profile = () => {
  return (
    <div className='grid  md:grid-cols-7 gap-5'>
      <div className='border border-gray-100 p-8 md:col-span-4 rounded-lg flex justify-center items-center'>
      ...
      <div className='border border-gray-100 p-7 md:col-span-3 rounded-lg gap-1 flex flex-col '>
